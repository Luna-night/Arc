...
@.str_0 = private unnamed_addr constant [26 x i8] c"Absolute value of -42 is:\00"
...
entry:
  ...
  %str_ptr = getelementptr inbounds [26 x i8], [26 x i8]* @.str_0, i64 0, i64 0
  ...
  call i32 (i8*, ...) @printf(i8* %fmt_int_ptr, i32 %1)
  ret i32 0
}
